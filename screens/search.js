...
import { Text, View, StyleSheet, TouchableOpacity, Image, Alert, Dimensions, Linking, Vibration, AsyncStorage } from 'react-native';
...
export default class SearchScreen extends React.Component {
    ...
    closeOptions=()=>{
        this.setState({optionInUse:false});
        this.storeData()
    }
    ...
    storeData = async () => {
        try {await AsyncStorage.setItem('theme',JSON.stringify({'theme':this.state.theme,'option':APIfeature}))} catch (error) {Alert.alert(error);}
    }
    
    retrieveData = async () => {try {const value = await AsyncStorage.getItem('theme');if (value !== null) {Alert.alert(value)}} catch (error) {Alert.alert(error);}};
                        ...
                        <SafeAreaProvider>
                            ...
                            <View style={this.state.theme?[styles.container,{backgroundColor:'#222222'}]:styles.container}>
                                <View style={styles.imageContainer}>
                                    <Image style={this.state.theme?[styles.image,{backgroundColor:'#888888'}]:styles.image} source={{ uri: this.state.image }} />
                        ...
                        <SafeAreaProvider>
                            ...
                            <View style={this.state.theme?[styles.container,{backgroundColor:'#222222'}]:styles.container}>
                                <View style={styles.listCont}>
                                    ...
                                    <List.Item style={styles.list} left={()=>{return <Text style={this.state.theme?[styles.listtxt,{color:'#ffffff'}]:styles.listtxt}>Face Detection</Text>}} right={()=>{return <Switch value={this.state.s2} color='#3b9ca3' onValueChange={value=>this.handleOption('s2',value,"FACE_DETECTION",5)}/>}}/>
                                        <Divider style={this.state.theme?{backgroundColor:'#aaaaaa'}:styles.devdColor}/>
                                    <List.Item style={styles.list} left={()=>{return <Text style={this.state.theme?[styles.listtxt,{color:'#ffffff'}]:styles.listtxt}>Text Detection</Text>}} right={()=>{return <Switch value={this.state.s4} color='#3b9ca3' onValueChange={value=>this.handleOption('s4',value,"TEXT_DETECTION",5)}/>}}/>
                                        <Divider style={this.state.theme?{backgroundColor:'#aaaaaa'}:styles.devdColor}/>
                                    <List.Item style={styles.list} left={()=>{return <Text style={this.state.theme?[styles.listtxt,{color:'#ffffff'}]:styles.listtxt}>Landmark Detection</Text>}} right={()=>{return <Switch value={this.state.s5} color='#3b9ca3' onValueChange={value=>this.handleOption('s5',value,"LANDMARK_DETECTION",5)}/>}}/>
                                        <Divider style={this.state.theme?{backgroundColor:'#aaaaaa'}:styles.devdColor}/>
                                    <List.Item style={styles.list} left={()=>{return <Text style={this.state.theme?[styles.listtxt,{color:'#ffffff'}]:styles.listtxt}>Handwritng Detection</Text>}} right={()=>{return <Switch value={this.state.s6} color='#3b9ca3' onValueChange={value=>this.handleOption('s6',value,"DOCUMENT_TEXT_DETECTION",5)}/>}}/>
                                        <Divider style={this.state.theme?{backgroundColor:'#aaaaaa'}:styles.devdColor}/>
                                    <List.Item style={styles.list} left={()=>{return <Text style={this.state.theme?[styles.listtxt,{color:'#ffffff'}]:styles.listtxt}>Image Properties</Text>}} right={()=>{return <Switch value={this.state.s7} color='#3b9ca3' onValueChange={value=>this.handleOption('s7',value,"IMAGE_PROPERTIES",5)}/>}}/>
                                        <Divider style={this.state.theme?{backgroundColor:'#aaaaaa'}:styles.devdColor}/>
                                </View>
                                    <List.Item style={styles.list} left={()=>{return <Text style={this.state.theme?[styles.listtxt,{color:'#ffffff'}]:styles.listtxt}>Enable Dark Theme</Text>}} right={()=>{return <Switch value={this.state.theme} onValueChange={val=>this.changeVal(val)}/>}}/>
                            </View>
                        </SafeAreaProvider>
                    )
                }
                    ...
                    <View style={this.state.theme?[styles.container,{backgroundColor:'#222222'}]:styles.container}>
                        ...
                        <Card.Title style={this.state.theme?[styles.titleS,{color:'#ffffff'}]:styles.titleS}>
                            ...
                            <View style={styles.dashS}>
                                ...
                                <TouchableRipple rippleColor={this.state.theme?'#00ffff33':'#00000022'} onPress={()=>Linking.openURL('mailto:suportwithfindbyimage@gmail.com')} style={this.state.theme?[styles.btnS,{backgroundColor:'#00000000',borderColor:'#00ffff',borderWidth:2}]:styles.btnS}>
